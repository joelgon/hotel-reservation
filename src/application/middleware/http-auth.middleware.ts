...
export const httpAuthMiddleware = (handler: middy.PluginObject | Handler<unknown, any>, { bodyDto, pathParametersDto }: { bodyDto?: new () => object, pathParametersDto?: new () => object } = {}): MiddyfiedHandler<any, any, any, any, any> => {
